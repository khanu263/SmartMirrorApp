...
public class RadioActivity extends AppCompatActivity {
    ...
    {{
        put("alternative", "http://69.46.75.98:80/;stream.mp3");
        put("ambient", "http://37.59.28.208:8722/;stream.mp3");
        put("blues", "http://206.190.136.140:5022/;stream.mp3");
        put("classic rock", "http://us1.internet-radio.com:8105/;stream.mp3");
        put("classical", "http://38.100.128.106:8000/;stream.mp3");
        put("country", "http://46.231.87.20:8300/;stream.mp3");
        put("dance", "http://stream2.dancewave.online:8080/;stream.mp3");
        put("disco", "http://newairhost.com:8034/;stream.mp3");
        put("easy listening", "http://us2.internet-radio.com:8181/;stream.mp3");
        put("electronic", "http://198.15.94.34:8006/;stream.mp3");
        put("folk", "http://66.225.205.8:8000/;stream.mp3");
        put("grunge", "http://167.114.210.232:8105/;stream.mp3");
        put("hip hop", "http://66.85.154.211:9224/;stream.mp3");
        put("indie", "http://31.14.40.21:7532/;stream.mp3");
        put("instrumental", "http://91.250.77.9:8060/;stream.mp3");
        put("jazz", "http://us3.internet-radio.com:8007/;stream.mp3");
        put("metal", "http://192.99.62.212:9408/;stream.mp3");
        put("oldies", "http://206.217.202.1:7610/;stream.mp3");
        put("pop", "http://78.46.246.97:9000/;stream.mp3");
        put("r & b", "http://5.39.79.33:80/;stream.mp3");
        put("reggae", "http://64.71.79.181:9998/;stream.mp3");
        put("rock", "http://206.190.150.92:8295/;stream.mp3");
        put("soul", "http://64.95.243.43:8000/;stream.mp3");
        put("soundtrack", "http://149.56.23.7:20082/;stream.mp3");
    }};
